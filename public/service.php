                                ...
                                <div class="container text-center ">
                                    ...
                                    <div class="row">
                                        <div class="col text fs-5 fw-bold">
                                            Piste .MP3 - 30 euros
                                            <button class="btn btn-danger btn-sm mt-5 mb-2 shadow p-3 mb-5 rounded"> Acheter </button>
                                        </div>
                                        ...
                                        <div class="col fw-bold">
                                            ...
                                            <button class="btn btn-danger btn-sm mt-2 mb-2 shadow p-3 mb-5 rounded"> Acheter </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
